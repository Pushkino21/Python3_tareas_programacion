# -*- coding: utf-8 -*-
"""
Created on Sat Aug 14 00:08:46 2021
...
def F_C():
    ...
    a=cm.get()
    r=(a-32)*(float(5/9))
    mensaje = str(cm.get())+"°" + " Fahrenheit equivalen a " + str(r) +"°"+" Centigrados"
...
w1.geometry('460x310')
w1.title("Fahrenheit a Celsius")
#Obtención de datos en Centímetros
tk.Label(w1,text="Fahrenheit a Celsius", padx=10,pady=10, ).pack()
cm=tk.DoubleVar()
...
btnCalcular=tk.Button(w1, text="Calcular", command=F_C).pack()
