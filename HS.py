# -*- coding: utf-8 -*-
"""
Created on Sat Aug 14 00:59:26 2021
...
def H_S():
    ...
    a=cm.get()
    r=a*3600
    mensaje = str(cm.get())+" horas equivalen a " + str(r) +" Segundos"
...
w1.geometry('460x310')
w1.title("Horas a Segundos")
#Obtención de datos en Centímetros
tk.Label(w1,text="Horas a Segundos", padx=10,pady=10, ).pack()
cm=tk.DoubleVar()
...
btnCalcular=tk.Button(w1, text="Calcular", command=H_S).pack()
